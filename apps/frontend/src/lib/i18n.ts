...
const zh: Dict = {
  ...
  "spotlight.open": "打开",
  "spotlight.switchKind": "切换形式",
  "spotlight.kindApp": "应用",
  "spotlight.kindWidget": "小组件",
  "spotlight.openAsApp": "以应用形式打开",
  "spotlight.openAsWidget": "添加为桌面小组件",
...
const en: Dict = {
  ...
  "spotlight.open": "Open",
  "spotlight.switchKind": "Other form",
  "spotlight.kindApp": "App",
  "spotlight.kindWidget": "Widget",
  "spotlight.openAsApp": "Open as an app",
  "spotlight.openAsWidget": "Add as a desktop widget",
