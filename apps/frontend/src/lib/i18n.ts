...
const zh: Dict = {
  ...
  "settings.models.imageHint": "用于在生成的界面中实时生成图片元素。图像生成相对较贵，可选择「关闭」。",
...
const en: Dict = {
  ...
  "settings.models.imageHint": "Generates image elements inside UIs in real time. Image generation can be costly — choose \"Off\" to disable.",
