...
export const AI_PROVIDERS: readonly ProviderCatalogEntry[] = [
  // — Local Agents (CLI subprocess; no key, configured via their own login) —
  {
    ...
    seedModels: [
      ...
      { id: "claude-opus-4.7", name: "Claude Opus 4.7", capabilities: TEXT },
      { id: "claude-opus-4.7-1m", name: "Claude Opus 4.7 1M", capabilities: TEXT },
      { id: "claude-opus-4.6", name: "Claude Opus 4.6", capabilities: TEXT },
      { id: "claude-opus-4.6-1m", name: "Claude Opus 4.6 1M", capabilities: TEXT },
      { id: "claude-sonnet-4.6", name: "Claude Sonnet 4.6", capabilities: TEXT },
      { id: "claude-sonnet-4.6-1m", name: "Claude Sonnet 4.6 1M", capabilities: TEXT },
      { id: "claude-haiku-4.5", name: "Claude Haiku 4.5", capabilities: TEXT },
      { id: "gemini-3.1-pro", name: "Gemini 3.1 Pro", capabilities: TEXT },
      ...
      { id: "gpt-5.3-codex", name: "GPT-5.3 Codex", capabilities: TEXT },
      { id: "gpt-5.1-codex", name: "GPT-5.1 Codex", capabilities: TEXT },
      { id: "gpt-5.1-codex-mini", name: "GPT-5.1 Codex Mini", capabilities: TEXT },
      { id: "glm-5.2-ioa", name: "GLM-5.2", capabilities: TEXT },
      { id: "glm-5v-turbo-ioa", name: "GLM-5v Turbo", capabilities: TEXT },
      { id: "glm-5.0-ioa", name: "GLM-5.0", capabilities: TEXT },
      { id: "glm-4.7-ioa", name: "GLM-4.7", capabilities: TEXT },
      { id: "minimax-m3-ioa", name: "MiniMax M3", capabilities: TEXT },
      { id: "minimax-m2.7-ioa", name: "MiniMax M2.7", capabilities: TEXT },
      { id: "minimax-m2.5-ioa", name: "MiniMax M2.5", capabilities: TEXT },
      { id: "kimi-k2.6-ioa", name: "Kimi K2.6", capabilities: TEXT },
      { id: "hy3-preview-agent-ioa", name: "Hy3 Preview", capabilities: TEXT },
      { id: "deepseek-v4-pro-ioa", name: "DeepSeek V4 Pro", capabilities: TEXT },
      { id: "deepseek-v4-flash-ioa", name: "DeepSeek V4 Flash", capabilities: TEXT },
      { id: "deepseek-v3-2-volc-ioa", name: "DeepSeek V3.2", capabilities: TEXT },
      { id: "default", name: "ImageGen", capabilities: IMG },
    ],
  },
